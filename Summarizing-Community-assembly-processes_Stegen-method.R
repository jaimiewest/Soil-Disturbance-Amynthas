...
### Arboretum (Gallistel)
bNTI = read.csv("Derived_data/Community_assembly_Arb/weighted_bNTI_Lak_Hel.csv", header=TRUE, check.names=FALSE, row.names = 1)
RCBC = read.csv("Derived_data/Community_assembly_Arb/RC_results_Lak_Hel.csv", header=TRUE, check.names=FALSE, row.names = 1)

# # Lakeshore
# bNTI = read.csv("Derived_data/Community_assembly_Lak/weighted_bNTI_Lak_Hel.csv", header=TRUE, check.names=FALSE, row.names = 1)
# RCBC = read.csv("Derived_data/Community_assembly_Lak/RC_results_Lak_Hel.csv", header=TRUE, check.names=FALSE, row.names = 1)
...
## Option to save
write.csv(Proc.ID,"Derived_data/Community_Assembly_Process_IDs_Arb_summary.csv")
#write.csv(Proc.ID,"Derived_data/Community_Assembly_Process_IDs_Lak_summary.csv")
